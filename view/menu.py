...
class Menu():
    ...
    def display_menu(self):
        ...
        while loop:                
            ...
            buttons.append(Button(pygame.Rect(self.window.get_size()[0]/2-150, 150, 300, 50), "Start a new career", btn_controller.start_game))
            buttons.append(Button(pygame.Rect(self.window.get_size()[0]/2-150, 225, 300, 50), "Load saved game", btn_controller.load_save))
            buttons.append(Button(pygame.Rect(self.window.get_size()[0]/2-150, 300, 300, 50), "Exit", btn_controller.quit_game))

            for btn in buttons:
                btn_controller.hover(self.window, btn)
